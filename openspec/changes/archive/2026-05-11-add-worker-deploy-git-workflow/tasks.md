...
- [x] 1.3 Use the fixed GHCR image path and keep manual dispatch free of required inputs.
...
- [x] 3.1 Add registry login using GitHub token context for GHCR.
- [x] 3.2 Generate image tags for commit SHA and release tags.
...
- [x] 4.1 Document workflow triggers, GHCR image path, and token-based registry authentication.
