...
```rust
pub use errors::{CommandError, CommandResult, NativeCommandError};
```
...
- [ ] **Step 3: Replace `command_error` with a generic mapper-taking version**
...
- [ ] **Step 4: Replace `command_error_with_duration` with a generic version**
...
- [ ] **Step 5: Adjust existing diagnostics tests only if compilation requires it**
...
pub fn get_runpod_placement_options_error(
    ...
    match error {
        ...
        | RunpodProviderError::WorkflowProviderApiKeyUnavailable(error) => match error {
            ...
            _ => GetRunpodPlacementOptionsErrorCode::StoreUnavailable,
        },
...
- [ ] **Step 6: Update catalog `command_error` calls**
...
- [ ] **Step 6: Update secret `command_error` calls**
...
fn secret_error(error: &SecretsStorageError) -> WorkspaceErrorKind {
    match error {
        ...
        _ => WorkspaceErrorKind::StoreUnavailable,
    }
}
...
- [ ] **Step 6: Update workspace `command_error` calls**
