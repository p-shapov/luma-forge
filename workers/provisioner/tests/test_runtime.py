...
class RuntimeTests(unittest.TestCase):
    ...
    def test_runtime_paths_use_custom_overlay_path(self):
        with tempfile.TemporaryDirectory() as directory:
    ...
    def test_runtime_paths_use_fixed_image_runtime_paths(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(paths.image_python_path, image_root.resolve() / ".venv/bin/python")
            self.assertEqual(paths.python_path, image_root.resolve() / ".venv/bin/python")
            self.assertEqual(paths.image_comfyui_root, image_root.resolve() / "ComfyUI")
